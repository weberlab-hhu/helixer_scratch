...
nor prediction of UTR regions with Augustus, so the metric Sub Genic F1, which excludes UTR,
...
Finally, the selected, quality, mapped RNAseq samples were quantified to
