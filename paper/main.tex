...
Helixer vs AUGUSTUS as well as Helixer vs the reference for all genomes (Figure \ref{fig:average_vs_augustus}). % H vs A main, H vs R supp
...
\section{Discussion}
With Helixer, we introduce a novel, deep-learning based tool for gene annotation
