...
\abstract{\textbf{Motivation:} Current state-of-the-art tools for the \textit{de novo} annotation of 
...
% normally contact is last author / person with permanent position (i.e. Andreas). 
% Not sure how important that is, but if we're skipping that, then we can change it back to Felix
