...
\botrule
\end{tabular}}{An intron inside a UTR region is encoded as intron and can be inferred from the prediction order.}
\end{table}
...
\begin{table}[!t]
\processtable{Class weights\label{tab:detailed_results}} {
\begin{tabular}{@{}lll@{}}
\toprule Class & Animal Value & Plant Value \\
\midrule
Intergenic & 0.7 & 0.3 \\
