...
{\it Capsella grandiflora}, \cite{slotte2013capsella}). The Ensemble animal dataset by and large
...
performance compared to Augustus \ref{supfig:rna_select} % subgenic F1 sorted by Helixer new plots
...
See Section \ref{supsec:overlapping} of the 
...
base pair biological site \citep{carninci2006genome},  % todo, citation for termination site as well
