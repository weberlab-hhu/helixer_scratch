...
\caption{high low accuracty by high low RNAseq support for ref}
\end{figure*}
...
\includegraphics[width=5.6cm]{images/cov_examples/average_vs_augustus}  % should be 8.6 when floats are sorted out right
\caption{A caption}
\end{figure*}
