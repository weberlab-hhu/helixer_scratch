...
A class wise evaluation including the calculation of the Genic % still could use a better location...
...
maximum epochs were reached or Genic F1 stopped improving and training was interrupted. % check / what was patience set to?
...
selected two models each, specifically the model with the best precision and the  % please check
...
Orthologs of highly conserved single-copy genes were identified in each genome using
...
we randomly selected only half BUSCO-generated training set, which resulted in a training set 
size and runtime comparable to the plants. 
