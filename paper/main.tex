...
AUGUSTUS does outperform us rather consistently on the smallest genomes, but struggles much more the larger the genomes get. The difference in prediction quality is especially strong for mammals, which tend to have large genomes with very long genes, and the largest plants.
...
Different set of training genomes could lead to a shift in strengths and weaknesses of the model while a larger and more spread out set of high quality genomes could result in a wider range of genomes with decent predictions.
