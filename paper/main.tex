...
\botrule
\end{tabular}}{The parameters of the dilated CNN model that performed the best according to the Genic F1 of the validation data of the respective training genomes. The best animal model was determined by 7+ runs and has circa 4.6 million parameters; the best plant model has around 2.1 million and .}
\end{table}
